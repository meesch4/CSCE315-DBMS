...
import java.util.*;
/**
 * Contains static methods that given a string, returns a Stack<String> object
 */
public class ShuntingYard {
     ...
     */
    private ArrayList<String> parsed_leaves;
    private Stack<String> post_fixed;
    ...
    private static void build_stack() {
        // Comparisons have precedence over operators eg. ("==" has greater precedence "&&")
