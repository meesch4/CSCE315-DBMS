...
public class SqlBaseListener extends SQLGrammarBaseListener {
    ...
    @Override public void enterNatural_join(SQLGrammarParser.Natural_joinContext ctx) { }
    @Override public void exitNatural_join(SQLGrammarParser.Natural_joinContext ctx) { }
